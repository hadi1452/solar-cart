...
const products = [
    // Solar Panels - Longi
    { id:1, name:"LONGi Hi-MO X10 645W Monofacial Panel", model:"LR7-72HVH-645M", category:"longi", price:29025000, badge:"New", badgeClass:"best", warranty:"12 Yr Product / 30 Yr Performance", image:"images/longi-645w.jpg", localImage:"images/longi-645w.jpg", specs:["Power: 645W","Type: N-Type HPBC 2.0","Efficiency: 24.1%"], perWatt:"Rs. 45,000/Watt", featured:true, rating:4.9, reviewCount:34 },
    { id:2, name:"Longi 610W Hi-MO 7 Bifacial Series Solar Panel", model:"LR8-66HGD-610M", category:"longi", price:27450000, badge:"Popular", badgeClass:"", warranty:"12 Yr Product / 30 Yr Performance", image:"images/longi-610w.jpg", localImage:"images/longi-610w.jpg", specs:["Power: 610W","Type: N-Type HPDC Bifacial","Efficiency: 22.8%"], perWatt:"Rs. 45,000/Watt", featured:true, rating:4.8, reviewCount:52 },

    // Solar Panels - Jinko
    { id:3, name:"Jinko 585W N-Type Bifacial Solar Panel", model:"JKM585N-72HL4-BDV", category:"jinko", price:26325000, badge:"Tier 1", badgeClass:"best", warranty:"12 Yr Product / 30 Yr Performance", image:"images/jinko-585w.jpg", localImage:"images/jinko-585w.jpg", specs:["Power: 585W","Type: N-Type Bifacial","Efficiency: 22.6%"], perWatt:"Rs. 45,000/Watt", featured:true, rating:4.7, reviewCount:28 },

    // Inverters (Official iTel images from itelsolar.com)
    { id:19, name:"itel 1.6kW Hybrid Solar Inverter", model:"IPV-1K512U", category:"inverter", price:52000, badge:"", warranty:"3 Years", image:"images/itel-1k6-v6.jpg", localImage:"images/itel-1k6-v6.jpg", specs:["Capacity: 1.5kW / 1.8kVA","Type: Hybrid IP54","PV Input: 650W Max"], featured:false, rating:4.5, reviewCount:6 },
    { id:4, name:"iTel 3kW Pro IP54 Hybrid Solar Inverter", model:"IPV-3K24UPRO", category:"inverter", price:79500, badge:"", warranty:"3 Years", image:"images/itel-3kw-v6.jpg", localImage:"images/itel-3kw-v6.jpg", specs:["Capacity: 3kW / 4.5kVA","Type: Hybrid IP54","Voltage: 24V"], featured:false, rating:4.5, reviewCount:18 },
    { id:5, name:"IPV-4K24U Pro iTel Inverter 4kW 24V SP Hybrid", model:"IPV-4K24UPRO", category:"inverter", price:123000, badge:"Popular", badgeClass:"", warranty:"5 Years", image:"images/itel-4kw-v6.jpg", localImage:"images/itel-4kw-v6.jpg", specs:["Capacity: 4kW","Type: Hybrid IP54","MPPT: Dual + WiFi"], featured:true, rating:4.8, reviewCount:41 },
    { id:6, name:"iTel 6kW Inverter Hybrid 48V IP54 IPV-6K48UPRO With WiFi", model:"IPV-6K48UPRO", category:"inverter", price:148000, badge:"Best Seller", badgeClass:"best", warranty:"5 Years", image:"images/itel-6kw-v6.jpg", localImage:"images/itel-6kw-v6.jpg", specs:["Capacity: 6kW","Type: Hybrid IP54","MPPT: 8kW PV + WiFi"], featured:true, rating:4.9, reviewCount:67 },
    { id:7, name:"IHY-6KL1A iTel 6kW IP66 Hybrid Solar Inverter", model:"IHY-6KL1A", category:"inverter", price:197000, badge:"IP66", badgeClass:"premium", warranty:"5 Years", image:"images/itel-6kw-ip66-v6.jpg", localImage:"images/itel-6kw-ip66-v6.jpg", specs:["Capacity: 6kW","Type: Hybrid IP66","PV Input: 12kW + WiFi"], featured:false, rating:4.6, reviewCount:15 },
    { id:10, name:"IP66-Rated 6.6kW Hybrid iTel Inverter", model:"IHY-6K6L1A", category:"inverter", price:195000, badge:"IP66", badgeClass:"premium", warranty:"5 Years", image:"images/itel-6k6-v6.jpg", localImage:"images/itel-6k6-v6.jpg", specs:["Capacity: 6.6kW","Type: Hybrid IP66","Feature: AI SmartGo + WiFi"], featured:false, rating:4.6, reviewCount:9 },
    { id:8, name:"iTel 8kW (IP54) Hybrid Solar Inverter", model:"IPV-8K48U", category:"inverter", price:197000, badge:"Best Value", badgeClass:"best", warranty:"5 Years", image:"images/itel-8kw-v6.jpg", localImage:"images/itel-8kw-v6.jpg", specs:["Capacity: 8kW / 8kVA","Type: Hybrid IP54","PV Input: 16kW Max"], featured:false, rating:4.7, reviewCount:23 },
    { id:9, name:"iTel 12kW Inverter Hybrid 48V IP54 IPV-12K48U With WiFi", model:"IPV-12K48U", category:"inverter", price:272000, badge:"Heavy Duty", badgeClass:"premium", warranty:"5 Years", image:"images/itel-12kw-v6.jpg", localImage:"images/itel-12kw-v6.jpg", specs:["Capacity: 12kW","Type: Hybrid IP54","MPPT: Dual + WiFi"], featured:false, rating:4.8, reviewCount:12 },
    { id:20, name:"iTel 8kW IP66 Hybrid Solar Inverter", model:"IHY-8KL3", category:"inverter", price:385000, badge:"New", badgeClass:"best", warranty:"5 Years", image:"images/itel-8kw-ip66-v6.jpg", localImage:"images/itel-8kw-ip66-v6.jpg", specs:["Capacity: 8kW","Type: Hybrid IP66","PV Input: 16kW Max"], featured:false, rating:4.6, reviewCount:0 },
    { id:21, name:"iTel 12kW IP66 Hybrid Solar Inverter", model:"IHY-12KL3", category:"inverter", price:592000, badge:"New", badgeClass:"best", warranty:"5 Years", image:"images/itel-12kw-ip66-v6.jpg", localImage:"images/itel-12kw-ip66-v6.jpg", specs:["Capacity: 12kW","Type: Hybrid IP66","MPPT: Dual + WiFi"], featured:false, rating:4.6, reviewCount:0 },
    { id:25, name:"iTel 50kW Hybrid Solar Inverter", model:"iTel-50K", category:"inverter", price:1360000, badge:"New", badgeClass:"best", warranty:"5 Years", image:"images/itel-50kw-v6.jpg", localImage:"images/itel-50kw-v6.jpg", specs:["Capacity: 50kW","Type: Hybrid","Grade: Commercial"], featured:false, rating:4.5, reviewCount:0 },
    { id:26, name:"iTel IC-H60X Switch Gear", model:"IC-H60X", category:"inverter", price:300000, badge:"New", badgeClass:"best", warranty:"5 Years", image:"images/itel-switchgear-v6.jpg", localImage:"images/itel-switchgear-v6.jpg", specs:["Type: Switch Gear","For: iTel Inverter Systems"], featured:false, rating:4.5, reviewCount:0 },

    // ESS Solution (Official iTel images from itelsolar.com)
    { id:16, name:"iTel Energy 500W Power Tank + 1kWh LiFePO4 All-In-One", model:"IESS-05K10N", category:"ess", price:72990, badge:"All-In-One", badgeClass:"best", warranty:"2 Years", image:"images/itel-ess-500w.jpg", localImage:"images/itel-ess-500w.jpg", specs:["Output: 500W / 1kWh","Battery: LiFePO4 6000+ Cycles","Ports: AC, USB-C, USB-A"], featured:true, rating:4.9, reviewCount:38 },
    { id:18, name:"iTel Power Go 320Wh Portable Power Station", model:"IESS-320T", category:"ess", price:29999, badge:"Portable", badgeClass:"best", warranty:"2 Years", image:"images/itel-ess-320.jpg", localImage:"images/itel-ess-320.jpg", specs:["Output: 130W / 320Wh","Battery: 100,000mAh LiFePO4","USB-C: 65W Fast Charge"], featured:true, rating:4.8, reviewCount:45 },
    ...
    { id:24, name:"iTel Battery-51100 X-G1 51.2V Lithium Battery", model:"51100-X-G1", category:"battery", price:245000, badge:"New", badgeClass:"best", warranty:"7 Years", image:"images/itel-bat51100xg1-v1.jpg", localImage:"images/itel-bat51100xg1-v1.jpg", specs:["Voltage: 51.2V","Type: LiFePO4"], featured:false, rating:4.5, reviewCount:0 }
];
...
function getProductStock(productId) {
    ...
    return DEFAULT_OUT_OF_STOCK_IDS.includes(productId) ? 0 : 100;
}
...
// ==================== PACKAGES ====================
const solarPackages = [
    { size:'3kW', label:'Small Home', panels:5, panelName:'Longi 610W', inverterId:4, batteryId:11, popular:false, wiringPrice:55000 },
    { size:'4kW', label:'Growing Home', panels:7, panelName:'Longi 610W', inverterId:5, batteryId:12, popular:false, wiringPrice:65000 },
    { size:'6kW', label:'Medium Home', panels:10, panelName:'Longi 610W', inverterId:6, batteryId:13, popular:true, wiringPrice:75000 },
    { size:'8kW', label:'Large Home', panels:13, panelName:'Longi 610W', inverterId:8, batteryId:13, popular:false, wiringPrice:85000 },
    { size:'12kW', label:'Villa / Office', panels:20, panelName:'Longi 610W', inverterId:9, batteryId:14, popular:false, wiringPrice:95000 }
];
...
const blogArticles = [
    ...
    { id:6, title:'Hybrid Vs On-Grid Vs Off-Grid Solar: Which One Do You Need?', tag:'Guide', date:'July 2026', img:'https://images.unsplash.com/photo-1497440001374-f26997328c1b?w=400', excerpt:'Confused about the three types of solar systems? Here is how to pick the right one for your home or business.', content:'<h3>On-Grid Systems</h3><p>Connected directly to the WAPDA/KESC grid with no battery. Cheapest option and eligible for net metering, but offers zero backup during load shedding.</p><h3>Off-Grid Systems</h3><p>Fully independent of the grid, relying entirely on batteries. Best for remote areas with no grid connection, but requires a larger, more expensive battery bank to cover all needs.</p><h3>Hybrid Systems</h3><p>The most popular choice in Pakistan today. Combines grid connection, solar panels, and battery backup in one — you get net metering savings during the day and seamless backup during outages.</p><h3>Our Recommendation</h3><p>For most Karachi homes facing regular load shedding, a hybrid system with a lithium battery offers the best balance of savings and reliability.</p>' },
    { id:7, title:'How Much Does A Solar System Really Cost In Pakistan?', tag:'Pricing', date:'July 2026', img:'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=400', excerpt:'A breakdown of what goes into the price of a solar system — panels, inverter, battery, wiring, and installation.', content:'<h3>What You Are Paying For</h3><p>A complete solar system price is made up of four main components: solar panels, the hybrid inverter, a lithium battery (if backup is needed), and wiring/installation labor.</p><h3>System Size Matters</h3><p>Larger systems cost more upfront but bring down your cost per watt, and generate more savings on your monthly bill. Use our Solar Calculator to get a personalized estimate based on your current electricity bill.</p><h3>Battery Adds The Most Cost</h3><p>If load shedding backup is your priority, expect the lithium battery to be a significant portion of your total investment — but it is also what delivers uninterrupted power during outages.</p><h3>Get An Accurate Quote</h3><p>Prices vary by brand, warranty, and installation complexity. Contact us on WhatsApp for a free, no-obligation quote tailored to your home.</p>' },
    { id:8, title:'5 Common Solar Installation Mistakes To Avoid', tag:'Tips', date:'July 2026', img:'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=400', excerpt:'Avoid these common pitfalls that reduce solar system performance and lifespan.', content:'<h3>1. Wrong Panel Orientation</h3><p>Panels installed at the wrong angle or facing the wrong direction can lose 20-30% of potential output. In Pakistan, south-facing panels tilted around 25-30 degrees perform best.</p><h3>2. Undersized Wiring</h3><p>Using thin or low-quality cables causes voltage drop and heat buildup, reducing efficiency and creating a fire risk over time.</p><h3>3. Ignoring Shading</h3><p>Even partial shade from a water tank or tree on one panel can drag down the output of an entire string. Always survey the roof carefully before installation.</p><h3>4. Skipping Proper Earthing</h3><p>Poor grounding puts both your equipment and household at risk during lightning strikes or electrical faults.</p><h3>5. DIY Without Experience</h3><p>Solar installation involves high-voltage DC wiring. Always use a certified installer to avoid safety hazards and warranty voids.</p>' },
    { id:9, title:'kW Vs kWh: What Do They Actually Mean?', tag:'Guide', date:'July 2026', img:'https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?w=400', excerpt:'The two most confusing terms in solar, explained simply so you can shop with confidence.', content:'<h3>kW: How Fast You Generate Power</h3><p>Kilowatt (kW) measures the rate of power generation or consumption at any given moment — it is the size of your solar system or inverter, like the size of a water pump.</p><h3>kWh: How Much Energy You Store Or Use</h3><p>Kilowatt-hour (kWh) measures total energy over time — 1kW running for 1 hour equals 1kWh. This is what your battery capacity and your WAPDA bill are measured in.</p><h3>Why It Matters When Shopping</h3><p>A 5kW inverter tells you how much load it can power at once (ACs, fridge, etc). A 5kWh battery tells you how long it can run that load before running out — roughly 1 hour at full 5kW load, or several hours at a lighter load.</p><h3>Quick Example</h3><p>If your home uses 1kW on average at night, a 5kWh battery gives you roughly 5 hours of backup.</p>' },
    { id:10, title:'Best Time Of Year To Install Solar In Pakistan', tag:'Tips', date:'July 2026', img:'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=400', excerpt:'Timing your installation right can mean faster setup, better pricing, and quicker payback.', content:'<h3>Before Peak Summer</h3><p>Installing in spring (March-April) means your system is fully operational before the highest electricity demand and highest bills hit in June-August — maximizing your first year of savings.</p><h3>Avoid Monsoon Rush</h3><p>Monsoon season (July-September) makes roof work harder and slower. Installers are also usually booked solid right before summer, so plan ahead.</p><h3>Winter Is Still Worth It</h3><p>Solar panels still generate meaningful power in winter, just less than summer. If your bill is high year-round, do not wait for a "perfect" season — earlier installation means earlier savings.</p><h3>Net Metering Approval Takes Time</h3><p>DISCO approval for net metering can take 4-8 weeks. Factor this into your timeline if you want to start exporting excess units as soon as possible.</p>' },
    { id:11, title:'Solar Inverter Types Explained: String Vs Hybrid Vs Off-Grid', tag:'Guide', date:'July 2026', img:'https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=400', excerpt:'The inverter is the brain of your solar system. Here is what each type actually does.', content:'<h3>String (Grid-Tie) Inverters</h3><p>Convert solar DC power to AC and sync directly with the grid. No battery support — if the grid goes down, so does your power, for safety reasons.</p><h3>Hybrid Inverters</h3><p>The standard choice in Pakistan today. Manage solar input, battery charging/discharging, and grid connection all in one unit, switching seamlessly during load shedding.</p><h3>Off-Grid Inverters</h3><p>Built for locations with no grid connection at all. Rely entirely on batteries and solar, with no net metering capability.</p><h3>What To Look For</h3><p>Check MPPT (Maximum Power Point Tracking) input capacity, IP rating for outdoor installation, and WiFi monitoring — all iTel hybrid inverters we stock include these as standard.</p>' }
];
